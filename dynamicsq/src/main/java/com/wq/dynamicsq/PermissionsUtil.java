...
public class PermissionsUtil {
    public static final String TAG = "DynamicSQ";
     ...
     * @param permission 要申请的权限
     */
    public static void requestPermission(Context context, boolean force, PermissionListener listener, String... permission) {
        requestPermission(context, force, listener, permission, true, null);
    }
    ...
    public static void requestPermission(@NonNull Context context, @NonNull boolean force, @NonNull PermissionListener listener, @NonNull String[] permission, boolean showTip, @Nullable TipInfo tip) {
        if (listener == null) {
            Log.e(TAG, "listener is null");
            return;
        }
    ...
    public static class TipInfo implements Serializable {
        ...
        public TipInfo(@Nullable String title, @Nullable String content, @Nullable String cancel, @Nullable String ensure, @Nullable boolean force) {
            this.title = title;
