...
public class PermissionActivity extends AppCompatActivity {
    ...
    private boolean defaultForce = false;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        defaultForce = getIntent().getBooleanExtra("force", false);
        Serializable ser = getIntent().getSerializableExtra("tip");

        if (ser == null) {
            tipInfo = new PermissionsUtil.TipInfo(defaultTitle, defaultContent, defaultCancel, defaultEnsure, defaultForce);
        } else {
